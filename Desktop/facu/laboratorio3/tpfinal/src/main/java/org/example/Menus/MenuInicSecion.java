...
public class MenuInicSecion {
    ...
    public static Usuario buscarUser(String usuario) {
        ...
        try {
            ...
            Usuario[] usuarios = objectMapper.readValue(new File("C:\\Users\\Julieta\\Desktop\\UTN 2023\\PROGRAMACION Y LABORATORIO 3\\TP FINAL 19-06\\TP Final clon 2\\tpFINAL\\Desktop\\facu\\laboratorio3\\tpfinal\\src\\main\\resources\\Usuarios.json"), Usuario[].class);
